...
| ------------- | ------------- | ------------- | ------------- |
| [FT News Watch ](https://github.com/rkclark/ft-news-watch)  | A server-rendered app that allows the user to search for articles from the [Financial Times](https://www.ft.com/?edition=uk) via the [FT Headline API](https://developer.ft.com/docs/license_quick_start/headlinelicense). I worked on the project as an individual, and was able to use it as an exercise to learn more about performance optimisation on the web. Using minification, browser caching, server caching and gzip compression I was able to achieve [Google PageSpeed Insights](https://developers.google.com/speed/pagespeed/insights/) ratings of 91/100 for mobile and 97/100 for desktop. | [Heroku](https://rkclark-ft-news-watch.herokuapp.com/) |  Express, Node.js, [Origami](http://origami.ft.com/), Gulp, Sass, Mocha, Chai, Sinon, WebdriverIO |
