...
| [Pixos ](https://github.com/rkclark/Pixos)  | A multiplayer card battling game constructed using the MERN stack with Redux and Socket-io. I pitched this project for the two week final project challenge at the Makers Academy as I wanted to take the new universal Javascript approach I learnt on the Steami project to the next level. The project scope was ambitious and it required a Herculean effort to learn brand new technologies such as Redux and Socket-io and successfully apply them to create a fully functional game. At the beginning we were way out of our depth, and I took on the role of technical architect in order to help guide the team towards a working MVP. I had to ask my teammates to take a leap of faith that my technical vision could be realised. I am proud that they were willing to trust in me and that we created something so engaging - with so much learning along the way!   | [Heroku](https://rkclark-pixos.herokuapp.com/) |  MongoDB, Express, React, Redux, Node.js, Socket-io, Passport, Webpack, Bootstrap, Sass, Material UI, Mocha, Chai, Enzyme |
